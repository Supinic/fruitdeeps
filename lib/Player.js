...
import { apply as applyBoosts, list as boostList } from "./Boosts.js";
...
export default class Player {
	...
	get allAttackStyles () {
		...
		if (exceptionData) {
			if (!this.equipment.weapon.category && exceptionData.category) {
				this.equipment.weapon.category = exceptionData.category;
			}
