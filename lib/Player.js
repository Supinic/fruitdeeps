...
export default class Player {
	...
	addBoost (boost) {
		if (new PotionDrinker().boostList()
			.includes(boost)) {
	...
	selectPrayer (prayer) {
		...
		if (prayerList.ranged.includes(prayer) || prayerList.magic.includes(prayer) || prayerList.melee.includes(prayer)) {
			...
			for (const oldprayer of [
				...prayerList.melee, ...prayerList.ranged, ...prayerList.attack, ...prayerList.magic
			]) {
			...
			for (const oldprayer of [
				...prayerList.melee, ...prayerList.ranged, ...prayerList.strength, ...prayerList.magic
			]) {
				this.deselectPrayer(oldprayer);
				this.prayers.push(prayer);
			}
