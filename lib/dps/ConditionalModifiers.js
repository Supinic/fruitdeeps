...
import * as leagues4Relics from "./modifiers/leagues4-relics.js";
...
// Player properties
export function setConditionalProperties (dps, player, monster) {
	const list = modifierList.filter(mod => typeof mod.setConditionalProperties === "function");
	for (const mod of list) {
		mod.setConditionalProperties(dps, player, monster);
	}
}
