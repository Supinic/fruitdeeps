...
import { isApplied as areRubyBoltsApplied } from "../modifiers/bolts/ruby.js";
...
export class Overhit {
	...
	timeToKill (hp) {
		...
		const player = new Player(this.state.player);
		if (areRubyBoltsApplied(this.calcs, player, this.state.monster)) {
