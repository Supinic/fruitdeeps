...
export class AttackerImport extends Component {
	...
	render () {
		...
		return (<div className="highlight-section flex-container-vertical">
				<div>
					<h3>Export</h3>
					<textarea className="input-invisible disabled" style={{
						resize: "vertical",
						minHeight: "3em"
					}} value={JSON.stringify(this.props.player.minimize())} disabled placeholder="{}">
					</textarea>
					<button onClick={this.copyToClipboard}>{copy}</button>
				</div>
				<div>
					<h3>Import</h3>
					<textarea className="input-invisible" style={{
						resize: "vertical",
						minHeight: "3em"
					}} placeholder="{}" ref={this.importRef}>
					</textarea>
