...
export class AttackerAttackStyles extends Component {
	...
	attackStyles () {
		...
		return styles.map((style, i) => <tr key={i}>
			<td>
			...
			<td><input type="radio" onChange={this.setStyle} value={i} id={"attack-style-select-" + i}
			           checked={i === this.props.player.attackStyleSelected}/></td>
		</tr>);
	}
